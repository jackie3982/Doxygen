...
parent class of \mbox{\hyperlink{classOfficer}{Officer}} and \mbox{\hyperlink{classSupervisor}{Supervisor}} 
...
Defualt cobstructor of the \mbox{\hyperlink{classEmployee}{Employee}} class, Sets all the variables to a set number.
...
\mbox{\hyperlink{classEmployee_a003c7bd08c40924e381eb0750cbb906f}{Employee()}}; Returns an default employee object. 
\end{DoxyReturn}
...
\end{DoxyPrecond}
\begin{DoxyReturn}{Returns}
\mbox{\hyperlink{classEmployee}{Employee}}(int Returns a employee object with set values 
\end{DoxyReturn}
\begin{DoxyPostcond}{Postcondition}
...
Prints the ID, years, hourly\+Rate, and hours\+Worked.
